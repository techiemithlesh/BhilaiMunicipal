...
import { swmConsumerDemandGenerateApi } from "../../../api/endpoints";
  ...
  const formFields = [
    {
      ...
      value: lastConnectionDtl?.categoryType || "",
      required: false,
      isDisabled: true,
    },
    {
      name: "subCategoryTypeMasterId",
      label: "Consumer Rang Type",
      type: "text",
      error: validationError?.subCategoryTypeMasterId || "",
      value: lastConnectionDtl?.subCategoryType || "",
      required: false,
      isDisabled: true,
    },
    {
      ...
      value: lastConnectionDtl?.dateOfEffective || "",
      required: false,
      isDisabled: true,
    },
    // {
    ...
    {
      name: "demandUpto",
      label: "Last Demand Upto",
      type: "Date",
      error: validationError?.demandUpto || "",
      value: lastConnectionDtl?.demandUpto || "",
      required: false,
      isDisabled: true,
    },
  ];
